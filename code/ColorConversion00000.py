...
# helper functions (cv2 does not provide these conversions)
...
# convert RGB to HSV
hsv_image = cv2.cvtColor(image, rgb2hsv) #last rendering of image is in RGB 
# show image 
